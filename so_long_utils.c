...
void set_heading(t_game_data *data, char type, t_point point)
{
    ...
    if (type == 'P')
    {
        if (data->player_heading == 1)
            data->assets.player = mlx_xpm_file_to_image(data->vars.mlx, "./assets/CharacterHeadingUp.xpm", &img_h, &img_h);
        else if (data->player_heading == 3)
            data->assets.player = mlx_xpm_file_to_image(data->vars.mlx, "./assets/CharacterHeadingRight.xpm", &img_h, &img_h);
        else if (data->player_heading == 4)
            data->assets.player = mlx_xpm_file_to_image(data->vars.mlx, "./assets/CharacterHeadingLeft.xpm", &img_h, &img_h);
        else
            data->assets.player = mlx_xpm_file_to_image(data->vars.mlx, "./assets/Character.xpm", &img_h, &img_h);
